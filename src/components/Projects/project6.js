      ...
      <div>
          ...
          <Modal onClose={this.showModal} show={this.state.show}>
            ...
            <div class="project-info">
              ...
              <p>
                LA Hair is a hair care and hair extension company that I had to recreate in my Web Development I course.
              </p>
            </div>
            <div class="project-info">
              <h3>THE <b>BRIEF</b></h3>
              <p>
                We were given a website that needed to be recreated into a more clean look. Before we started we had to do
              ...
              <p>
                On the contact page I created a contact form that will submit to the companies email. I also added a Google maps
                ...
                the footer area also displays a second nav section that displays the frequently asked questions, credits, site map,
